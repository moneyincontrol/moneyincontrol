                ...
                <form onSubmit={handlePhoneOTPVerify} className="space-y-5">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white text-center text-3xl tracking-widest font-mono focus:outline-none focus:border-emerald-500/50" 
                      maxLength="6" 
                    />
                  </div>
